...
const PORTFOLIO = [
  { cat: "personal", icon: "person", ar: { t: "الدكتور فهمي عرم", d: "موقع شخصي (بورتفليو) احترافي للدكتور فهمي عرم." }, en: { t: "Dr. Fahmi Aram", d: "A professional personal portfolio site for Dr. Fahmi Aram." } },
