...
const PORTFOLIO = [
  ...
  { url: "https://craftfoliostudio4.github.io/Saleh-Bin-Al-Shakl/", img: "Image/صالح بن الشكل.png", cat: "personal", icon: "person", ar: { t: "صالح أحمد بن الشكل", d: "موقع شخصي (بورتفوليو) احترافي لصالح أحمد بن الشكل." }, en: { t: "Saleh Ahmed Bin Al-Shakl", d: "A professional personal portfolio site for Saleh Ahmed Bin Al-Shakl." } }
];
...
const TESTIMONIALS = [
  ...
  { img: "Image/شعار نوتس باند.png", name: "فرقة نوتس باند", nameEn: "Notes Band", role: { ar: "فرقة موسيقية حضرمية", en: "Hadhrami musical band" }, comment: { ar: "بصراحة، إحنا في فرقة نوتس باند كنا ندور على موقع يعكس روح موسيقانا وشغفنا، وكرافتفوليو ستوديو فهموا الفكرة من أول لحظة. صمموا لنا موقع يبرز هويتنا بشكل عصري وجميل، والتعامل معاهم كان سلس واحترافي جداً. شكراً لهم على هذي التحفة الفنية اللي زادت من تواصلنا مع جمهورنا!", en: "Honestly, we at Notes Band were looking for a website that reflects the soul of our music and our passion, and Craftfolio Studio understood the idea from the very first moment. They designed a site that highlights our identity in a modern and beautiful way, and dealing with them was very smooth and professional. Thanks to them for this masterpiece that enhanced our connection with our audience!" } },
  ...
  { img: "Image/صالح بن الشكل ايقونة.png", name: "صالح أحمد بن الشكل", nameEn: "Saleh Ahmed Bin Al-Shakl", role: { ar: "طالب طب وجراحة الفم والأسنان | كاتب ومؤلف | صانع محتوى إعلامي", en: "Dental Student | Writer and Author | Media Content Creator" }, comment: { ar: "تجربة مميزة جداً مع كرافتفوليو ستوديو، حيث كان الاهتمام بأدق التفاصيل والاحترافية العالية في التصميم والتطوير هي العنوان الأبرز لهذا العمل. شكراً لكم على هذا الإبداع.", en: "A very special experience with Craftfolio Studio, where attention to the smallest details and high professionalism in design and development were the highlights of this work. Thank you for this creativity." } }
];
